...
class Config:
    ...
    num_envs = 4  # Number of environments to use for training
    num_buffers = 4  # Number of buffers to use for training
    rollout_batch_size = 2**14  # Number of steps to rollout
    ...
    ppo_training_batch_size = 32  # Number of rows in a training batch
